...
# import all flask-forms
from app.forms.shareform import ShareForm
from app.forms.viewshareform import CommentForm
...
def view_share(share_id):
    ...
    if form.validate_on_submit():
        ...
        parent_id = form.parent_id.data  # Get parent comment ID from the form
    ...
    return render_template("view_share.html", share=share, comments=top_comments, form=form)
